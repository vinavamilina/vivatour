      ...
      <div class="card-body login-card-body">
        ...
        <form action="" method="post">
          <div class="input-group mb-3">
            <input type="text" name="nama_pengguna" class="form-control <?= form_error('nama_pengguna') ? 'is-invalid' : '' ?>" placeholder="Nama Pengguna">
          ...
          <div class="input-group mb-3">
            <input type="password" name="kata_sandi" class="form-control <?= form_error('kata_sandi') ? 'is-invalid' : '' ?>" placeholder="Kata Sandi">
            <div class="input-group-append">
              <div class="input-group-text">
